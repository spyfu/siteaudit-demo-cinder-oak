...
$expectedRepository = 'spyfu/siteaudit-demo-cinder-oak'
$expectedRemoteHttps = 'https://github.com/spyfu/siteaudit-demo-cinder-oak.git'
$expectedRemoteSsh = 'git@github.com:spyfu/siteaudit-demo-cinder-oak.git'
